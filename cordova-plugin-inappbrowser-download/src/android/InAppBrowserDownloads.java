...
public class InAppBrowserDownloads implements DownloadListener {
    ...
    public void onRequestPermissionResult(int requestCode, String[] permissions,
            ...
            System.out.println("onRequestPermissionsResult___________________333");
    ...
    protected void processDownload() {
        ...
        plugin.cordova.getActivity().registerReceiver(attachmentDownloadCompleteReceive, intentFilter, Context.RECEIVER_NOT_EXPORTED);
